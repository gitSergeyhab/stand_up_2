...
export function ComedianPageInfo() {
  ...
  const testText  = `
  По словам женщины, поначалу зрители не вызвали особых подозрений. Были дерзкими, {& Комисаренко #> /comedians/1/info &} но трезвыми и опрятными. «Они просидели практически все мероприятие.{& comedian-test@> images/comedians/olnii-koncert-komika-Slavi-Komissarenko-sostoitsya-vBreste-22-aprelya_1685558128836.jpg&}
