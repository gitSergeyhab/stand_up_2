...
import { ChatColor, SocketEvent } from "../../const/chat";
...
import { getActiveRoom, getChatPosition } from "../../store/chat-reducer/chat-selectors";
...
export function ChatBlock({ onHide, hide }: ChatBlockProps) {
  ...
  return (
    <ChatSection hide={hide} position={position}>
